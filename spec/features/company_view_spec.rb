...
describe "the company view", type: :feature do
  ...
  describe "#phone_numbers" do
    ...
    before(:each) do
      company.phone_numbers.create(number: "867-5309")
  ...
  describe "#email_addresses" do
    ...
    before(:each) do
      company.email_addresses.create(address: "molsen@example.com")
      company.email_addresses.create(address: "belieber@example.com")
